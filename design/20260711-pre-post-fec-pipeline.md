...
2. `∂_i X_j`、`∂_x u`等のFormurae derivative sugarを`strict∂/∂`を使うEgison式へ置換する。
...
| `curl` | `epsilon_i~j~k . strict∂/∂ X_k coordinates~j` | Levi-Civita縮約の2行 |
