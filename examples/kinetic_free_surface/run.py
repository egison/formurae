...
PARAMETERS=['lengthX', 'lengthY', 'warpX', 'warpY', 'scenario', 'gravity', 'level', 'amplitude', 'waveCenter', 'waveWidth', 'bedStart', 'bedSlope', 'speed', 'tau', 'timeScale', 'periodic', 'method', 'surfacePosition', 'fittedBed', 'wetFraction', 'heightMethod', 'wallSlip', 'boundarySlope', 'collisionImplicit', 'compression', 'launch', 'alignmentFloor']
