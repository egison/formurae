...
static int report(Formura_Navi n) {
  printf("%d,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g,%.17g\n", n.time_step/5,
         n.reduce_water, n.reduce_bank, n.reduce_speed, n.reduce_rmin,
         n.reduce_rmax, n.reduce_overhang, n.reduce_bad, n.reduce_gauge_offshore,
         n.reduce_gauge_surf, n.reduce_shore_overhang, n.reduce_downward_speed, n.reduce_runup);
  fflush(stdout);
...
int main(int argc, char **argv) {
  ...
  puts("step,water,bank,speed,rmin,rmax,overhang,bad,gauge_offshore,gauge_surf,shore_overhang,downward_speed,runup");
  int ok=report(n);
  dump(n, argv[3]);
