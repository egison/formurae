...
static Formura_Comm_Buff send_buf1_p1_0[2][32];
static Formura_Comm_Buff recv_buf1_m1_0[2][32];
static Formura_Comm_Buff send_buf1_0_p1[32][2];
static Formura_Comm_Buff recv_buf1_0_m1[32][2];
static Formura_Comm_Buff send_buf1_p1_p1[2][2];
static Formura_Comm_Buff recv_buf1_m1_m1[2][2];
...
void Formura_Step(Formura_Buff * buff,Formura_Grid_Struct * rslt,Formura_Navi n,int block_offset_1,int block_offset_2) {
for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
...
for(int i2 = 0; i2 < 32; i2 += 1) {
send_buf1_p1_0[i1][i2].q = formura_data.q[i1+30][i2];
}
}

MPI_Request send_req_p1_0;
MPI_Isend(send_buf1_p1_0,sizeof(send_buf1_p1_0),MPI_BYTE,n->rank_p1_0,0,n->mpi_world,&send_req_p1_0);
MPI_Request recv_req_m1_0;
MPI_Irecv(recv_buf1_m1_0,sizeof(recv_buf1_m1_0),MPI_BYTE,n->rank_m1_0,0,n->mpi_world,&recv_req_m1_0);
for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 2; i2 += 1) {
send_buf1_0_p1[i1][i2].q = formura_data.q[i1][i2+30];
}
}

MPI_Request send_req_0_p1;
MPI_Isend(send_buf1_0_p1,sizeof(send_buf1_0_p1),MPI_BYTE,n->rank_0_p1,0,n->mpi_world,&send_req_0_p1);
MPI_Request recv_req_0_m1;
MPI_Irecv(recv_buf1_0_m1,sizeof(recv_buf1_0_m1),MPI_BYTE,n->rank_0_m1,0,n->mpi_world,&recv_req_0_m1);
for(int i1 = 0; i1 < 2; i1 += 1) {
for(int i2 = 0; i2 < 2; i2 += 1) {
send_buf1_p1_p1[i1][i2].q = formura_data.q[i1+30][i2+30];
}
}

MPI_Request send_req_p1_p1;
MPI_Isend(send_buf1_p1_p1,sizeof(send_buf1_p1_p1),MPI_BYTE,n->rank_p1_p1,0,n->mpi_world,&send_req_p1_p1);
MPI_Request recv_req_m1_m1;
MPI_Irecv(recv_buf1_m1_m1,sizeof(recv_buf1_m1_m1),MPI_BYTE,n->rank_m1_m1,0,n->mpi_world,&recv_req_m1_m1);
...
for(int i1 = 0; i1 < 2; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
buff.q[i1][i2+2] = recv_buf1_m1_0[i1][i2].q;
}
}

for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 2; i2 += 1) {
buff.q[i1+2][i2] = recv_buf1_0_m1[i1][i2].q;
}
}

for(int i1 = 0; i1 < 2; i1 += 1) {
for(int i2 = 0; i2 < 2; i2 += 1) {
buff.q[i1][i2] = recv_buf1_m1_m1[i1][i2].q;
}
}

for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
buff.q[i1+2][i2+2] = formura_data.q[i1][i2];
}
}

Formura_Step(&buff,&formura_data,*n,0,0);
