...
double r[4][4][4][4][12][12];
} Formura_Tmp_Wall_1;
typedef struct {
double q[6][4][4][12][4][12];
double r[6][4][4][12][4][12];
} Formura_Tmp_Wall_2;
typedef struct {
double q[6][4][4][12][12][4];
double r[6][4][4][12][12][4];
} Formura_Tmp_Wall_3;
typedef struct {
double q;
double r;
...
tmp_floor.r[i1+16][i2+16][i3+16] = formura_data.r[i1][i2][i3];
}
}
}
...
send_buf8_p1_0_0[i1][i2][i3].r = formura_data.r[i1+16][i2][i3];
}
}
}
...
send_buf8_0_p1_0[i1][i2][i3].r = formura_data.r[i1][i2][i3];
}
}
}
...
send_buf8_0_0_p1[i1][i2][i3].r = formura_data.r[i1][i2][i3];
}
}
}
...
send_buf8_p1_p1_0[i1][i2][i3].r = formura_data.r[i1+16][i2][i3];
}
}
}
...
send_buf8_p1_0_p1[i1][i2][i3].r = formura_data.r[i1+16][i2][i3];
}
}
}
...
send_buf8_0_p1_p1[i1][i2][i3].r = formura_data.r[i1][i2][i3];
}
}
}
...
send_buf8_p1_p1_p1[i1][i2][i3].r = formura_data.r[i1+16][i2][i3];
}
}
}
...
rslt.r[i1][i2][i3] = tmp_floor.r[i1+40-8*j1][i2+24-8*j2][i3+24-8*j3];
}
}
}
...
tmp_floor.r[i1+40-8*j1][i2+24-8*j2][i3+24-8*j3] = rslt.r[i1][i2][i3];
}
}
}
...
tmp_floor.r[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].r;
}
}
}
...
tmp_floor.r[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].r;
}
}
}
