...
typedef struct {
double Bx[2][2][4][4][20][20];
double By[2][2][4][4][20][20];
double Bz[2][2][4][4][20][20];
double Ex[2][2][4][4][20][20];
double Ey[2][2][4][4][20][20];
double Ez[2][2][4][4][20][20];
} Formura_Tmp_Wall_1;
typedef struct {
double Bx[9][2][4][20][4][20];
double By[9][2][4][20][4][20];
double Bz[9][2][4][20][4][20];
double Ex[9][2][4][20][4][20];
double Ey[9][2][4][20][4][20];
double Ez[9][2][4][20][4][20];
} Formura_Tmp_Wall_2;
typedef struct {
double Bx[9][2][4][20][20][4];
double By[9][2][4][20][20][4];
double Bz[9][2][4][20][20][4];
double Ex[9][2][4][20][20][4];
double Ey[9][2][4][20][20][4];
double Ez[9][2][4][20][20][4];
} Formura_Tmp_Wall_3;
typedef struct {
double Bx;
double By;
...
static Formura_Comm_Buff send_buf8_0_p1_0[128][16][16];
static Formura_Comm_Buff recv_buf8_0_m1_0[128][16][16];
static Formura_Comm_Buff send_buf8_0_0_p1[128][16][16];
static Formura_Comm_Buff recv_buf8_0_0_m1[128][16][16];
...
static Formura_Comm_Buff send_buf8_0_p1_p1[128][16][16];
static Formura_Comm_Buff recv_buf8_0_m1_m1[128][16][16];
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1+16][i2+16][i3+16] = formura_data.Bx[i1][i2][i3];
tmp_floor.By[i1+16][i2+16][i3+16] = formura_data.By[i1][i2][i3];
tmp_floor.Bz[i1+16][i2+16][i3+16] = formura_data.Bz[i1][i2][i3];
tmp_floor.Ex[i1+16][i2+16][i3+16] = formura_data.Ex[i1][i2][i3];
tmp_floor.Ey[i1+16][i2+16][i3+16] = formura_data.Ey[i1][i2][i3];
tmp_floor.Ez[i1+16][i2+16][i3+16] = formura_data.Ez[i1][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_p1_0_0[i1][i2][i3].Bx = formura_data.Bx[i1+112][i2][i3];
send_buf8_p1_0_0[i1][i2][i3].By = formura_data.By[i1+112][i2][i3];
send_buf8_p1_0_0[i1][i2][i3].Bz = formura_data.Bz[i1+112][i2][i3];
send_buf8_p1_0_0[i1][i2][i3].Ex = formura_data.Ex[i1+112][i2][i3];
send_buf8_p1_0_0[i1][i2][i3].Ey = formura_data.Ey[i1+112][i2][i3];
send_buf8_p1_0_0[i1][i2][i3].Ez = formura_data.Ez[i1+112][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_0_p1_0[i1][i2][i3].Bx = formura_data.Bx[i1][i2][i3];
send_buf8_0_p1_0[i1][i2][i3].By = formura_data.By[i1][i2][i3];
send_buf8_0_p1_0[i1][i2][i3].Bz = formura_data.Bz[i1][i2][i3];
send_buf8_0_p1_0[i1][i2][i3].Ex = formura_data.Ex[i1][i2][i3];
send_buf8_0_p1_0[i1][i2][i3].Ey = formura_data.Ey[i1][i2][i3];
send_buf8_0_p1_0[i1][i2][i3].Ez = formura_data.Ez[i1][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_0_0_p1[i1][i2][i3].Bx = formura_data.Bx[i1][i2][i3];
send_buf8_0_0_p1[i1][i2][i3].By = formura_data.By[i1][i2][i3];
send_buf8_0_0_p1[i1][i2][i3].Bz = formura_data.Bz[i1][i2][i3];
send_buf8_0_0_p1[i1][i2][i3].Ex = formura_data.Ex[i1][i2][i3];
send_buf8_0_0_p1[i1][i2][i3].Ey = formura_data.Ey[i1][i2][i3];
send_buf8_0_0_p1[i1][i2][i3].Ez = formura_data.Ez[i1][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_p1_p1_0[i1][i2][i3].Bx = formura_data.Bx[i1+112][i2][i3];
send_buf8_p1_p1_0[i1][i2][i3].By = formura_data.By[i1+112][i2][i3];
send_buf8_p1_p1_0[i1][i2][i3].Bz = formura_data.Bz[i1+112][i2][i3];
send_buf8_p1_p1_0[i1][i2][i3].Ex = formura_data.Ex[i1+112][i2][i3];
send_buf8_p1_p1_0[i1][i2][i3].Ey = formura_data.Ey[i1+112][i2][i3];
send_buf8_p1_p1_0[i1][i2][i3].Ez = formura_data.Ez[i1+112][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_p1_0_p1[i1][i2][i3].Bx = formura_data.Bx[i1+112][i2][i3];
send_buf8_p1_0_p1[i1][i2][i3].By = formura_data.By[i1+112][i2][i3];
send_buf8_p1_0_p1[i1][i2][i3].Bz = formura_data.Bz[i1+112][i2][i3];
send_buf8_p1_0_p1[i1][i2][i3].Ex = formura_data.Ex[i1+112][i2][i3];
send_buf8_p1_0_p1[i1][i2][i3].Ey = formura_data.Ey[i1+112][i2][i3];
send_buf8_p1_0_p1[i1][i2][i3].Ez = formura_data.Ez[i1+112][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_0_p1_p1[i1][i2][i3].Bx = formura_data.Bx[i1][i2][i3];
send_buf8_0_p1_p1[i1][i2][i3].By = formura_data.By[i1][i2][i3];
send_buf8_0_p1_p1[i1][i2][i3].Bz = formura_data.Bz[i1][i2][i3];
send_buf8_0_p1_p1[i1][i2][i3].Ex = formura_data.Ex[i1][i2][i3];
send_buf8_0_p1_p1[i1][i2][i3].Ey = formura_data.Ey[i1][i2][i3];
send_buf8_0_p1_p1[i1][i2][i3].Ez = formura_data.Ez[i1][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
send_buf8_p1_p1_p1[i1][i2][i3].Bx = formura_data.Bx[i1+112][i2][i3];
send_buf8_p1_p1_p1[i1][i2][i3].By = formura_data.By[i1+112][i2][i3];
send_buf8_p1_p1_p1[i1][i2][i3].Bz = formura_data.Bz[i1+112][i2][i3];
send_buf8_p1_p1_p1[i1][i2][i3].Ex = formura_data.Ex[i1+112][i2][i3];
send_buf8_p1_p1_p1[i1][i2][i3].Ey = formura_data.Ey[i1+112][i2][i3];
send_buf8_p1_p1_p1[i1][i2][i3].Ez = formura_data.Ez[i1+112][i2][i3];
}
}
}
...
for(int j2 = 0; j2 < 0; j2 += 1) {
for(int j3 = 0; j3 < 0; j3 += 1) {
for(int i1 = 0; i1 < 16; i1 += 1) {
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
rslt.Bx[i1][i2][i3] = tmp_floor.Bx[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
rslt.By[i1][i2][i3] = tmp_floor.By[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
rslt.Bz[i1][i2][i3] = tmp_floor.Bz[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
rslt.Ex[i1][i2][i3] = tmp_floor.Ex[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
rslt.Ey[i1][i2][i3] = tmp_floor.Ey[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
rslt.Ez[i1][i2][i3] = tmp_floor.Ez[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3];
}
}
}
...
buff.Bx[i1+16][i2][i3] = tmp_wall_1.Bx[j2][j3][it][i1][i2][i3];
buff.By[i1+16][i2][i3] = tmp_wall_1.By[j2][j3][it][i1][i2][i3];
buff.Bz[i1+16][i2][i3] = tmp_wall_1.Bz[j2][j3][it][i1][i2][i3];
buff.Ex[i1+16][i2][i3] = tmp_wall_1.Ex[j2][j3][it][i1][i2][i3];
buff.Ey[i1+16][i2][i3] = tmp_wall_1.Ey[j2][j3][it][i1][i2][i3];
buff.Ez[i1+16][i2][i3] = tmp_wall_1.Ez[j2][j3][it][i1][i2][i3];
}
}
}
...
for(int i3 = 0; i3 < 20; i3 += 1) {
buff.Bx[i1][i2+16][i3] = tmp_wall_2.Bx[j1][j3][it][i1][i2][i3];
buff.By[i1][i2+16][i3] = tmp_wall_2.By[j1][j3][it][i1][i2][i3];
buff.Bz[i1][i2+16][i3] = tmp_wall_2.Bz[j1][j3][it][i1][i2][i3];
buff.Ex[i1][i2+16][i3] = tmp_wall_2.Ex[j1][j3][it][i1][i2][i3];
buff.Ey[i1][i2+16][i3] = tmp_wall_2.Ey[j1][j3][it][i1][i2][i3];
buff.Ez[i1][i2+16][i3] = tmp_wall_2.Ez[j1][j3][it][i1][i2][i3];
}
}
}
...
buff.Bx[i1][i2][i3+16] = tmp_wall_3.Bx[j1][j2][it][i1][i2][i3];
buff.By[i1][i2][i3+16] = tmp_wall_3.By[j1][j2][it][i1][i2][i3];
buff.Bz[i1][i2][i3+16] = tmp_wall_3.Bz[j1][j2][it][i1][i2][i3];
buff.Ex[i1][i2][i3+16] = tmp_wall_3.Ex[j1][j2][it][i1][i2][i3];
buff.Ey[i1][i2][i3+16] = tmp_wall_3.Ey[j1][j2][it][i1][i2][i3];
buff.Ez[i1][i2][i3+16] = tmp_wall_3.Ez[j1][j2][it][i1][i2][i3];
}
}
}

Formura_Step(&buff,&rslt,*n,+128-16*j1,+16-16*j2,+16-16*j3);
for(int i1 = 0; i1 < 4; i1 += 1) {
for(int i2 = 0; i2 < 20; i2 += 1) {
for(int i3 = 0; i3 < 20; i3 += 1) {
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.Bx[i1][i2][i3];
tmp_floor.By[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.By[i1][i2][i3];
tmp_floor.Bz[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.Bz[i1][i2][i3];
tmp_floor.Ex[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.Ex[i1][i2][i3];
tmp_floor.Ey[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.Ey[i1][i2][i3];
tmp_floor.Ez[i1+128-16*j1][i2+16-16*j2][i3+16-16*j3] = rslt.Ez[i1][i2][i3];
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].Bx;
tmp_floor.By[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].By;
tmp_floor.Bz[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].Bz;
tmp_floor.Ex[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].Ex;
tmp_floor.Ey[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].Ey;
tmp_floor.Ez[i1][i2+16][i3+16] = recv_buf8_m1_0_0[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].Bx;
tmp_floor.By[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].By;
tmp_floor.Bz[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].Bz;
tmp_floor.Ex[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].Ex;
tmp_floor.Ey[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].Ey;
tmp_floor.Ez[i1+16][i2][i3+16] = recv_buf8_0_m1_0[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].Bx;
tmp_floor.By[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].By;
tmp_floor.Bz[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].Bz;
tmp_floor.Ex[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].Ex;
tmp_floor.Ey[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].Ey;
tmp_floor.Ez[i1+16][i2+16][i3] = recv_buf8_0_0_m1[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].Bx;
tmp_floor.By[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].By;
tmp_floor.Bz[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].Bz;
tmp_floor.Ex[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].Ex;
tmp_floor.Ey[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].Ey;
tmp_floor.Ez[i1][i2][i3+16] = recv_buf8_m1_m1_0[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].Bx;
tmp_floor.By[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].By;
tmp_floor.Bz[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].Bz;
tmp_floor.Ex[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].Ex;
tmp_floor.Ey[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].Ey;
tmp_floor.Ez[i1][i2+16][i3] = recv_buf8_m1_0_m1[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].Bx;
tmp_floor.By[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].By;
tmp_floor.Bz[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].Bz;
tmp_floor.Ex[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].Ex;
tmp_floor.Ey[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].Ey;
tmp_floor.Ez[i1+16][i2][i3] = recv_buf8_0_m1_m1[i1][i2][i3].Ez;
}
}
}
...
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
tmp_floor.Bx[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].Bx;
tmp_floor.By[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].By;
tmp_floor.Bz[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].Bz;
tmp_floor.Ex[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].Ex;
tmp_floor.Ey[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].Ey;
tmp_floor.Ez[i1][i2][i3] = recv_buf8_m1_m1_m1[i1][i2][i3].Ez;
}
}
}

for(int j1 = 7; j1 < 9; j1 += 1) {
for(int j2 = 0; j2 < 0; j2 += 1) {
for(int j3 = 0; j3 < 0; j3 += 1) {
for(int i1 = 0; i1 < 16; i1 += 1) {
for(int i2 = 0; i2 < 16; i2 += 1) {
...
for(int j1 = 0; j1 < 9; j1 += 1) {
for(int j2 = 0; j2 < 2; j2 += 1) {
for(int j3 = 0; j3 < 0; j3 += 1) {
for(int i1 = 0; i1 < 16; i1 += 1) {
for(int i2 = 0; i2 < 16; i2 += 1) {
for(int i3 = 0; i3 < 16; i3 += 1) {
