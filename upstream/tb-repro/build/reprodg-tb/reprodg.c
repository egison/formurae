...
static Formura_Comm_Buff send_buf4_p1_0[8][32];
static Formura_Comm_Buff recv_buf4_m1_0[8][32];
static Formura_Comm_Buff send_buf4_0_p1[32][8];
static Formura_Comm_Buff recv_buf4_0_m1[32][8];
static Formura_Comm_Buff send_buf4_p1_p1[8][8];
static Formura_Comm_Buff recv_buf4_m1_m1[8][8];
...
double a0 = buff->q[i1+1][i2+1];
double a1 = 2.0e-2;
double a2 = buff->q[i1+2][i2+2];
double a3 = buff->q[i1][i2];
double a4 = a2+a3;
double a5 = buff->q[i1+2][i2];
double a6 = a4+a5;
double a7 = buff->q[i1][i2+2];
double a8 = a6+a7;
double a9 = 4.0;
double a10 = a9*a0;
double a11 = a8-a10;
...
for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
tmp_floor.q[i1+8][i2+8] = formura_data.q[i1][i2];
}
}

for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
send_buf4_p1_0[i1][i2].q = formura_data.q[i1+24][i2];
}
}

MPI_Request send_req_p1_0;
MPI_Isend(send_buf4_p1_0,sizeof(send_buf4_p1_0),MPI_BYTE,n->rank_p1_0,0,n->mpi_world,&send_req_p1_0);
MPI_Request recv_req_m1_0;
MPI_Irecv(recv_buf4_m1_0,sizeof(recv_buf4_m1_0),MPI_BYTE,n->rank_m1_0,0,n->mpi_world,&recv_req_m1_0);
for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
send_buf4_0_p1[i1][i2].q = formura_data.q[i1][i2+24];
}
}

MPI_Request send_req_0_p1;
MPI_Isend(send_buf4_0_p1,sizeof(send_buf4_0_p1),MPI_BYTE,n->rank_0_p1,0,n->mpi_world,&send_req_0_p1);
MPI_Request recv_req_0_m1;
MPI_Irecv(recv_buf4_0_m1,sizeof(recv_buf4_0_m1),MPI_BYTE,n->rank_0_m1,0,n->mpi_world,&recv_req_0_m1);
for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
send_buf4_p1_p1[i1][i2].q = formura_data.q[i1+24][i2+24];
}
}

MPI_Request send_req_p1_p1;
MPI_Isend(send_buf4_p1_p1,sizeof(send_buf4_p1_p1),MPI_BYTE,n->rank_p1_p1,0,n->mpi_world,&send_req_p1_p1);
MPI_Request recv_req_m1_m1;
MPI_Irecv(recv_buf4_m1_m1,sizeof(recv_buf4_m1_m1),MPI_BYTE,n->rank_m1_m1,0,n->mpi_world,&recv_req_m1_m1);
for(int j1 = 0; j1 < 3; j1 += 1) {
for(int j2 = 0; j2 < 3; j2 += 1) {
for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
rslt.q[i1][i2] = tmp_floor.q[i1+32-8*j1][i2+32-8*j2];
}
}
...
Formura_Step(&buff,&rslt,*n,+32-8*j1,+32-8*j2);
for(int i1 = 0; i1 < 2; i1 += 1) {
for(int i2 = 0; i2 < 10; i2 += 1) {
...
for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
tmp_floor.q[i1+32-8*j1][i2+32-8*j2] = rslt.q[i1][i2];
}
}
...
for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 32; i2 += 1) {
tmp_floor.q[i1][i2+8] = recv_buf4_m1_0[i1][i2].q;
}
}

for(int i1 = 0; i1 < 32; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
tmp_floor.q[i1+8][i2] = recv_buf4_0_m1[i1][i2].q;
}
}

for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
tmp_floor.q[i1][i2] = recv_buf4_m1_m1[i1][i2].q;
}
}

for(int j1 = 3; j1 < 5; j1 += 1) {
for(int j2 = 0; j2 < 3; j2 += 1) {
for(int i1 = 0; i1 < 8; i1 += 1) {
for(int i2 = 0; i2 < 8; i2 += 1) {
rslt.q[i1][i2] = tmp_floor.q[i1+32-8*j1][i2+32-8*j2];
