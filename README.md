...
[連続する3つの波](examples/wave_train/README.md)では，長い2次元水槽に3つの初期波を置き，
浅瀬へ進み，波頭が崩れて岸へ乗り上げるところまで計算します．水槽全体と浅瀬の拡大図に加え，
2地点の水の量を動画に示します．`make wave-train-demo` で実行・描画，
`make wave-train-verify` で3波の到達・水量保存・静水・1波との比較を検査できます．
